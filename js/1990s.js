let container1990sPage = document.getElementById("container");
...
for (let record of STORE_RECORDS) if (record.category == "1990s") currentPageRecords.push(record)

const displayItems = () => {
    for (let record of currentPageRecords) {
        if (record.category == "1990s") {
            container1990sPage.innerHTML +=
